            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'image_width', title: __('Imagewidth')},
                        {field: 'image_height', title: __('Imageheight')},
                        {field: 'image_type', title: __('Imagetype')},
                        {field: 'storage', title: __('Storage')},
                        {field: 'file_size', title: __('Filesize')},
                        {field: 'mime_type', title: __('Mimetype')},
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'image_width', title: __('Imagewidth')},
                        {field: 'image_height', title: __('Imageheight')},
                        {field: 'mime_type', title: __('Mimetype'), operate: 'LIKE %...%',
