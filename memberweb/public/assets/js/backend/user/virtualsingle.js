        		...
        		$(document).ready(function(){
        			...
        			$('#referee_user_code').blur(function() { 
        				...
        				if (old_referee_user_code!=new_referee_user_code&&re.test($("#referee_user_code").val())) {
        					...
        					$.ajax({
		                        url: "user/virtualsingle/checkRefereeUserCode",
		                        type: 'post',
		                        dataType: 'json',
					...
					$("#random").on("click",function(){
						$.ajax({
	                        url: "user/virtualsingle/getRandomCode",
	                        type: 'post',
	                        dataType: 'json',
	                        success: function (ret) {
					...
					$("#isExistCode").on("click",function(){
						...
						if (re.test($("#user_code").val())) {
							$.ajax({
		                        url: "user/virtualsingle/isExistCode",
		                        type: 'post',
		                        dataType: 'json',
					...
					$("#is_declaration_form_code").on("click",function(){
						...
						if (re.test($("#declaration_form_code").val())) {
							$.ajax({
		                        url: "user/virtualsingle/getUserNameByCode",
		                        type: 'post',
		                        dataType: 'json',
					...
					$("#is_manage_user_code").on("click",function(){
						...
						if (re.test($("#manage_user_code").val())) {
							$.ajax({
		                        url: "user/virtualsingle/checkManageUserCode",
		                        type: 'post',
		                        dataType: 'json',
