define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'product/orderform/index',
                    deal_url: 'product/orderform/deal',
                    del_url: 'product/orderform/del',
             ...
             $(document).ready(function(){
                 ...
                 $("#confirm_order").on("click",function(){
                    Layer.open({
                        ...
                        , yes: function () {
                                $.ajax({
                                    url: "product/orderform/orderstate",
                                    type: 'post',
                                    dataType: 'json',
