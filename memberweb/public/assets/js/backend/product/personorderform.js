define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'product/personorderform/index',
                    add_url: 'product/personorderform/add',
                    del_url: 'product/personorderform/del',
                    ...
                    [
                        ...
                        {field: 'operate', title: __('Operate'), table: table,
                            buttons: [{
                                ...
                                url: 'product/personorderform/detail'
                            }],
        ...
        add: function () {
            ...
            $(document).ready(function(){
                ...
                $("#product").on("change",function(){
                    $.ajax({
                        url: "product/personorderform/getRealpriceById",
                        type: 'post',
                        dataType: 'json',
                        data: {id: $(this).val()},
