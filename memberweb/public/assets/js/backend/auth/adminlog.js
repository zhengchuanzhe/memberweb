            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'user_name', title: __('User code'), formatter: Table.api.formatter.search},
                        ...
                        {field: 'create_time', title: __('Create time'), formatter: Table.api.formatter.datetime, operate: 'BETWEEN', type: 'datetime', addclass: 'datetimepicker', data: 'data-date-format="YYYY-MM-DD HH:mm:ss"'},
        ...
        api: {
            ...
            formatter: {
                browser: function (value, row, index) {
                    return '<a class="btn btn-xs btn-browser">' + row.user_agent.split(" ")[0] + '</a>';
                },
            },
        }
    };
