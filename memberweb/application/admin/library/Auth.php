...
class Auth extends \fast\Auth
{
    ...
    {
        return Session::get('admin_login_info.' . $name);
    }

    /**
     * 设置错误信息
     * @Author   zzk
     * @DateTime 2018-02-28T10:25:29+0800
     ...
     * 获取错误信息
     * @Author   zzk
     * @DateTime 2018-02-28T10:25:36+0800
    ...
    public function login($user_code, $password, $keeptime = 0)
    {
        $admin = Admin::get(['user_code' => $user_code]);
        if (!$admin)
        {
            $this->setError(__('Username is incorrect'));
            return false;
        }
        // zzk 20180228
        // 验证用户状态是否正常
        ...
        $admin->save();
        Session::set("admin_login_info", $admin);
    ...
    public function autologin()
    {
        ...
        if ($id && $keeptime && $expiretime && $key && $expiretime > time())
        {
            ...
            Session::set("admin_login_info", $admin->toArray());
            //刷新自动登录的时效
            $this->keeplogin($keeptime);
            return true;
        }
    ...
    public function isLogin()
    {
        ...
        $admin = Session::get('admin_login_info');
        if (!$admin)
        {
            return false;
        }
    ...
    public function getUserInfo($uid = null)
    {
        ...
        return $uid != $this->id ? Admin::get(intval($uid)) : Session::get('admin_login_info');
    }
